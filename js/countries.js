const COUNTRY_FLAGS = {
  ...
  'Bolivia': 'BO', 'Bonaire, Saint Eustatius and Saba ': 'BQ', 'Bosnia and Herzegovina': 'BA',
  ...
  'Curacao': 'CW', 'Cyprus': 'CY', 'Czechia': 'CZ', 'Democratic Republic of the Congo': 'CD',
  ...
  'Puerto Rico': 'PR', 'Qatar': 'QA', 'Republic of the Congo': 'CG', 'Reunion': 'RE',
  'Romania': 'RO', 'Russia': 'RU', 'Rwanda': 'RW', 'Saint Barthelemy': 'BL',
...
function flagEmoji(countryName) {
  ...
  if (!code) {
    const fallback = countryName.slice(0, 2).toUpperCase();
    return String.fromCodePoint(0x1F1E6 + fallback.charCodeAt(0) - 65, 0x1F1E6 + fallback.charCodeAt(1) - 65);
  }
