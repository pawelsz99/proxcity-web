...
function iconHeartEmpty(color) {
  ...
  return '<svg viewBox="0 0 14 13" width="14" height="13" style="display:inline;vertical-align:-1px">' +
    '<path fill="' + c + '" fill-rule="evenodd" d="M0,3.57C0.02,1.643 1.551,0 3.522,0C4.732,0 5.62,0.599 6.185,1.16C6.325,1.298 6.447,1.437 6.552,1.566C6.656,1.437 6.778,1.298 6.918,1.16C7.483,0.599 8.372,0 9.581,0C11.552,0 13.083,1.643 13.103,3.57L13.103,3.57C13.14,7.309 10.136,9.888 7.142,11.921C6.968,12.039 6.762,12.102 6.552,12.102C6.341,12.102 6.135,12.039 5.961,11.921C2.967,9.888 -0.037,7.309 0,3.57L0,3.57Z"/>' +
    '</svg>';
}
